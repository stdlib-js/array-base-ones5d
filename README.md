...
```javascript
ones5d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-ones5d@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/array-base-ones5d/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/array-base-ones5d/actions/workflows/test.yml?query=branch:v0.2.3
